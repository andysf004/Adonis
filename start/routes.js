...
Route.group(() => {
  ...
  Route.resource('projects.tasks', 'TaskController').apiOnly().validator(new Map([[['task.store'], ['Task']]])) // cria rotas "localhost/:project/tasks" pois tasks são filhos de project
